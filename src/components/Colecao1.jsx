        ...
        <>
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                ...
                <div className="flex-1 flex justify-center lg:justify-end relative">
                    <img src={Camisa} alt="camisa-supreme" className="absolute -top-10 -mx-8 transform scale-[2] -rotate-40 transition-transform duration-300 hover:-scale-x-100" style={{ width: '1200px', height: 'auto' }} />
                </div>
            </div>
        </>
     );
