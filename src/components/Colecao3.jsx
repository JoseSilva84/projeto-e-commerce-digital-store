...
Beats Bass</h1>
                ...
                <div className="flex-1 flex justify-center lg:justify-end relative">
                    <img src={Fone} alt="fone" className="absolute -top-12 w-48 h-36 transform scale-[1.6] transition-transform rotate-40 duration-300 hover:-scale-x-100" />
                </div>
            </div>
        </>
     );
